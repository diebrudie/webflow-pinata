...
(() => {
  ...
  // global-project-bbet.ts
  (0, import_jquery.default)(".c-nav__btn-hamb-lottie").on("click", function() {
    (0, import_jquery.default)(".c-nav__menu").toggleClass("is--open");
    (0, import_jquery.default)("body").toggleClass("no-scroll");
  });
  (0, import_jquery.default)(".c-nav__menu-link.is--dropdown").on("mouseenter mouseleave", function() {
    (0, import_jquery.default)("body").toggleClass("no-scroll");
  });
  (0, import_jquery.default)(".nav__menu-link").on("mouseenter mouseleave", function() {
    (0, import_jquery.default)(this).find(".nav__menu-link-arrow.is--external").toggleClass("is--active");
  });
  (0, import_jquery.default)(document).ready(function() {
    (0, import_jquery.default)(".nav__hamburger-lottie").on("click", function() {
      hamburgerMenu();
    });
    (0, import_jquery.default)(".c-footer__link").on("mouseenter mouseleave", function() {
      (0, import_jquery.default)(this).find(".c-footer__link-arrow").toggleClass("is--active");
    });
    (0, import_jquery.default)(".c-logos-crypto__logo-img.is--normal").on(
      "mouseenter mouseleave",
      function() {
        (0, import_jquery.default)(this).siblings(".c-logos-crypto__hover-txt").toggleClass("is--active");
        (0, import_jquery.default)(this).toggleClass("is--active");
      }
    );
    (0, import_jquery.default)(".c-logos-crypto__wrp").on("mouseenter mouseleave", function() {
      (0, import_jquery.default)(this).siblings(".c-logos-crypto__hover-txt").toggleClass("is--active");
      (0, import_jquery.default)(this).find(".c-logos-crypto__logo-img.is--grayscale").toggleClass("is--inactive");
      (0, import_jquery.default)(this).find(".c-logos-crypto__logo-img.is--original").toggleClass("is--active");
    });
    if ((0, import_jquery.default)(window).width() > 992) {
      let revealDropdown2 = function(currentLink, currentContent) {
        const dropdownValue = currentLink.attr("data-dropdown");
        const targetDropdown = (0, import_jquery.default)(
          `.nav__menu-dp-content[data-dropdown="${dropdownValue}"]`
        );
        dropdownWrap.css("display", "flex");
        showDropdown.restart();
        gsapWithCSS.set(menuArrow, {
          width: currentLink.outerWidth(),
          x: currentLink.offset().left
        });
        gsapWithCSS.set(menuBG, {
        ...
        gsapWithCSS.set(targetDropdown, {
          opacity: 1
        });
      }, switchDropdown2 = function(currentLink, previousContent, currentContent) {
        const dropdownValue = currentLink.attr("data-dropdown");
        const targetDropdown = (0, import_jquery.default)(
          `.nav__menu-dp-content[data-dropdown="${dropdownValue}"]`
        );
        gsapWithCSS.to(menuArrow, {
          width: currentLink.outerWidth(),
          x: currentLink.offset().left
        });
        gsapWithCSS.to(menuBG, {
          width: currentContent.outerWidth(),
          height: currentContent.outerHeight()
        });
        let moveDistance = 10;
      ...
      var revealDropdown = revealDropdown2, switchDropdown = switchDropdown2;
      (0, import_jquery.default)(
        "a, .nav__menu-dp-link, .w-checkbox-input, .w-form-label, .w-inline-block"
      ).mouseenter(function() {
        (0, import_jquery.default)(".cursor").click();
      });
      (0, import_jquery.default)(
        "a, .nav__menu-dp-link, .w-checkbox-input, .w-form-label, .w-inline-block"
      ).mouseleave(function() {
      ...
      let menuLink = (0, import_jquery.default)(".nav__menu-dp-link");
      let content = (0, import_jquery.default)(".nav__menu-dp-content");
      let menuBG = (0, import_jquery.default)(".nav__menu-bg");
      let dropdownWrap = (0, import_jquery.default)(".nav__menu-content");
      let menuArrow = (0, import_jquery.default)(".nav__menu-arrow-wrp");
      let inBetweenLinks = (0, import_jquery.default)(".nav__menu-link").attr("data-links");
      gsapWithCSS.defaults({
        duration: 0.4
      });
      let showDropdown = gsapWithCSS.timeline({
        paused: true,
        onReverseComplete: () => {
      ...
      menuLink.on("mouseenter", function() {
        let dropdownValue = (0, import_jquery.default)(this).attr("data-dropdown");
        ...
        if (previousLink.length === 0) {
          ...
          revealDropdown2((0, import_jquery.default)(this), currentContent);
        } else if (previousLink[0] !== this) {
          previousLink.removeClass("active");
          previousContent.removeClass("active");
          (0, import_jquery.default)(this).addClass("active");
          currentContent.addClass("active");
          switchDropdown2((0, import_jquery.default)(this), previousContent, currentContent);
        }
      });
      (0, import_jquery.default)(".nav__menu-dp-wrap [data-link='innerLink']").on(
        "mouseenter",
        function() {
          showDropdown.reverse();
        }
      );
      (0, import_jquery.default)(".nav__menu-dp-wrap").on("mouseleave", function() {
        showDropdown.reverse();
      });
    }
  });
